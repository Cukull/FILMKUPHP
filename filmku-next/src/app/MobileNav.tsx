        ...
        <div style={{ flex: 1, padding: '16px 0' }}>
          ...
          <div>
            ...
            {session ? (
              ...
              <>
                <Link href="/auth" onClick={onClose} style={{ display: 'flex', alignItems: 'center', gap: '12px', padding: '11px 24px', textDecoration: 'none', color: 'rgba(255,255,255,0.55)', fontSize: '14px', fontWeight: 500, borderLeft: '3px solid transparent' }}>
                  <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.2" strokeLinecap="round" strokeLinejoin="round">
