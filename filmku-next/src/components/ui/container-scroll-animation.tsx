...
export const Card = ({
  ...
  return (
    <motion.div
      ...
      className="max-w-5xl -mt-16 mx-auto h-[22rem] md:h-[32rem] w-full border-4 border-[#6C6C6C] p-2 md:p-6 bg-[#222222] rounded-[30px] shadow-2xl relative z-20"
    >
      <div className="h-full w-full overflow-hidden rounded-2xl bg-gray-100 dark:bg-zinc-900 md:rounded-2xl md:p-4 relative z-10">
        {children}
      </div>
    </motion.div>
  );
